...
RUN --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-cache,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
