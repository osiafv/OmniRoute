...
RUN --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-cache,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
# broken image.
RUN --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-npm-cache,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-next-cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-cache-locked,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/0a5bfcc0-28e1-45ee-bf1d-1ba00787a419-apt-lists-locked,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
