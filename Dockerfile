...
RUN --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-apt-cache,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-apt-lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
# broken image.
RUN --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-npm-cache,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-next-cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-apt-cache,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/a722a5bb-f6b2-4177-a4f4-d0b9a401868a-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
